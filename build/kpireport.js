...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__actions_kpireport_kpireport__ = __webpack_require__(630);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	...
	//全量
	return Object(__WEBPACK_IMPORTED_MODULE_7_redux__["bindActionCreators"])(__WEBPACK_IMPORTED_MODULE_8__actions_kpireport_kpireport__, dispatch);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KpiListFn", function() { return KpiListFn; });
function toQueryString(obj) {
	return obj ? Object.keys(obj).sort().map(function (key) {
		var val = obj[key];
		if (Array.isArray(val)) {
...
var KpiListFn = function KpiListFn(token, props) {
